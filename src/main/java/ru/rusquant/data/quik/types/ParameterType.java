...
public enum ParameterType {
     ...
     **/
    QTY, /**
     * Количество бумаг в последней сделке
     **/
    TIME, /**
     * Время последней сделки
     **/
    VOLTODAY, /**
     * Количество бумаг в обезличенных сделках
     **/
    VALTODAY, /**
     * Оборот в деньгах
     **/
     ...
     **/
    CURRENTVALUE, /**
     * Текущее значение индексов Московской Биржи
     **/
    LASTVALUE, /**
     * Значение индексов Московской Биржи на закрытие предыдущего дня
     **/
    LASTTOPREVSTLPRC, /**
     * Разница цены последней к предыдущей сессии
     **/
     ...
     **/
    LASTBID, /**
     * Лучшая спрос на момент завершения периода торгов
     **/
    LASTOFFER, /**
     * Лучшее предложение на момент завершения торгов
     **/
    PREVLEGALCLOSEPR, /**
    ...
    public static String getAvailableParameters() {
        ...
        for (ParameterType type : ParameterType.values()) {
            ...
            if (counter < ParameterType.values().length) {
                availableParameters += ", ";
            }
            counter++;
        }
